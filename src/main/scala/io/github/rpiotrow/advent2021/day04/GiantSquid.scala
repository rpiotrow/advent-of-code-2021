  ...
  val solution: Solution =
    for
      ...
      solution <- ZStream
        ...
        .use[ZEnv, String | java.io.IOException, (Long, Long)] {
          case ((firstWinningBoardNumberOption, firstWinningBoardState), restOfStream) =>
            for
              ...
              _ <- Console.printLine(s"Score of first winning board is $firstWinningBoardScore")
              ...
              lastWinningBoardNumber <- ZIO.getOrFailWith("last winning board number does not exist")(
                lastWinningBoardNumberOption
              )
              ...
              _ <- Console.printLine(s"Score of last winning board is $lastWinningBoardScore")
